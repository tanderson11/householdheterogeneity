...
def to_normal_inputs(point):
    ...
    use_trait_crib = True
    # check for trait crib HERE TKTK
    ...
    #print(point)
    default_parameters = region.parameter_class(**params).to_normal_inputs(use_beta_crib=use_beta_crib, use_trait_crib=use_trait_crib)
...
if __name__ == '__main__':
    ...
    if do_use_crib:
        ...
        crib_region = known_good_region

    parameters = calculate_region_parameters(region, crib_region=crib_region)
    ...
    beta_frame.to_csv('./new_precalculated_beta_frame.csv')