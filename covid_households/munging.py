...
if to_munge == "jing":
	...
	df = pd.read_excel("~/covid_households/empirical/ShahReview/Jing Household secondary attack rate of COVID-19 and associated determinants in Guangzhou/Data/Data_For_Statistical_Analysis_New.xlsx")
